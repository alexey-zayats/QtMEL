...
defined($$(FFMPEG_LIBRARY_PATH)): LIBS += -L$$(FFMPEG_LIBRARY_PATH)
defined($$(FFMPEG_INCLUDE_PATH)): INCLUDEPATH += $$(FFMPEG_INCLUDE_PATH)

defined($$(OPENCV_LIBRARY_PATH)): LIBS += -L$$(OPENCV_LIBRARY_PATH)
defined($$(OPENCV_INCLUDE_PATH)): INCLUDEPATH += $$(OPENCV_INCLUDE_PATH)
